...
/proc/get_sfx(S)
	...
	switch(S)
		...
		if("OB")
			S = pick('sound/effects/OB_warning_announce.ogg')
		if("morse")
			S = pick('sound/effects/sos-morse-code.ogg')
		if("shutters")
			S = pick('sound/effects/shutters_alarm.ogg')
		if("powerloss")
			S = pick('sound/effects/powerloss.ogg')
		if("revive")
			S = pick('sound/effects/gladosmarinerevive.ogg')
		if("sparks")
		...
		if("nade_prime")
			S = pick('sound/weapons/armbomb.ogg')
		...
		if("alien_hiss_expanded")
			S = pick('sound/voice/hiss1.ogg','sound/voice/hiss2.ogg','sound/voice/hiss3.ogg','sound/voice/hiss4.ogg','sound/voice/hiss5.ogg','sound/voice/alien_hiss1.ogg','sound/voice/alien_hiss2.ogg','sound/voice/alien_hiss3.ogg')
		if("alien_tail_swipe")
		...
		if("alien_death")
			S = pick('sound/voice/alien_death.ogg','sound/voice/alien_death2.ogg')
		if("alien_roar")
		...
		if("queen_distant")
			S = pick('sound/voice/alien_queen_command.ogg','sound/voice/alien_queen_command2.ogg','sound/voice/alien_queen_command3.ogg', 'sound/voice/alien_distantroar_3.ogg')
		if("alien_ventpass")

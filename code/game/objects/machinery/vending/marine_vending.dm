...
/obj/machinery/vending/MarineMed/valhalla
	...
	products = list(
		...
		"Valhalla" = list(
			...
			/obj/item/reagent_containers/hypospray/autoinjector/nanoblood = -1,
			...
			/obj/item/reagent_containers/hypospray/autoinjector/toxin_purge = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/toxin_purge/advanced = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/toxin_heal = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/toxin_heal/advanced = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/emergency = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/emergency/advanced = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/painkiller = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/paracetamol = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/somolent = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/isotonic/big = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/imialky = -1,
			/obj/item/reagent_containers/hypospray/autoinjector/stimulant = -1,
		)
	)

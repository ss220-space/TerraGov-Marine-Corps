...
GLOBAL_LIST_INIT(department_radio_keys_ru, list(
	MODE_KEY_R_HAND_RU = MODE_R_HAND,
	MODE_KEY_L_HAND_RU = MODE_L_HAND,
	MODE_KEY_INTERCOM_RU = MODE_INTERCOM,

	MODE_KEY_DEPARTMENT_RU = MODE_DEPARTMENT,

	RADIO_KEY_MEDICAL_RU = RADIO_CHANNEL_MEDICAL,
	RADIO_KEY_ENGINEERING_RU = RADIO_CHANNEL_ENGINEERING,
	RADIO_KEY_COMMAND_RU = RADIO_CHANNEL_COMMAND,
	RADIO_KEY_ALPHA_RU = RADIO_CHANNEL_ALPHA,
	RADIO_KEY_BRAVO_RU = RADIO_CHANNEL_BRAVO,
	RADIO_KEY_CHARLIE_RU = RADIO_CHANNEL_CHARLIE,
	RADIO_KEY_DELTA_RU = RADIO_CHANNEL_DELTA,
	RADIO_KEY_CAS_RU = RADIO_CHANNEL_CAS,
	RADIO_KEY_REQUISITIONS_RU = RADIO_CHANNEL_REQUISITIONS,
))
...
GLOBAL_LIST_INIT(department_radio_keys_rebel_ru, list(
	MODE_KEY_R_HAND_RU = MODE_R_HAND,
	MODE_KEY_L_HAND_RU = MODE_L_HAND,
	MODE_KEY_INTERCOM_RU = MODE_INTERCOM,
	...
	RADIO_KEY_MEDICAL_RU = RADIO_CHANNEL_MEDICAL_REBEL,
	RADIO_KEY_ENGINEERING_RU = RADIO_CHANNEL_ENGINEERING_REBEL,
	RADIO_KEY_COMMAND_RU = RADIO_CHANNEL_COMMAND_REBEL,
	RADIO_KEY_ALPHA_RU = RADIO_CHANNEL_ALPHA_REBEL,
	RADIO_KEY_BRAVO_RU = RADIO_CHANNEL_BRAVO_REBEL,
	RADIO_KEY_CHARLIE_RU = RADIO_CHANNEL_CHARLIE_REBEL,
	RADIO_KEY_DELTA_RU = RADIO_CHANNEL_DELTA_REBEL,
	RADIO_KEY_CAS_RU = RADIO_CHANNEL_CAS_REBEL,
	RADIO_KEY_REQUISITIONS_RU = RADIO_CHANNEL_REQUISITIONS_REBEL,
))

...
/mob/new_player/proc/view_lore()
	...
	output += "<a href='byond://?src=[REF(src)];lobby_choice=marines'>TerraGov морпех корпус</A><br><br><a href='byond://?src=[REF(src)];lobby_choice=aliens'>Улей ксеноморфов</A>"
	output += "</div>"
...
/mob/new_player/proc/view_marines()
	var/output = "<div align='center'>"
	output += "<p>Вглядываясь в оглушительную пустоту космоса, вы думаете со сколькими угрозами человечеству вам придется столкнуться и какая ещё угроза только ждет своего часа.<br/><br/>Миссия <b>корпуса морской пехоты корпорации TerraGov</b> заключается поддержании и принуждении к соблюдению космического закона установленного TerraGov. Корпус морской пехоты должен защищать территорию самой Терры, колоний солнечной системы и за её пределами. Братство морской пехоты состоит из добровольцев с разных миров и слоев общества готовых отдать свою жизнь ради высшей цели защиты этого самого общества, из которого они вышли.<br/><br/>Пройдя через очередную мясорубку, командир вновь загнал всех в криокапсулы в ожидание миссии. Корабль вышел на орбиту новой планеты. И вот вы вновь ощущаете тяжесть от долгого сна, просыпаясь лишь затем, что бы начать новую войну.<br/><br/>Наши враги, такие как мятежные против закона TerraGov колонии, несущие хаос Сыны Марса, и всепожирающие Ульи Ксеноморфов желают лишь одного – нашей смерти. Но нас направляет воля TerraGov и у нас нет права умирать. Мы щит оберегающий верных граждан и меч карающий врагов TerraGov. Поражение и смерть это удел людей, а мы солдаты ТГМС!</p>"
	output += "</div>"

	var/datum/browser/popup = new(src, "marines", "<div align='center'>TerraGov морпех корпус</div>", 480, 600)
	popup.set_content(output)
	popup.open(FALSE)

/mob/new_player/proc/view_aliens()
	var/output = "<div align='center'>"
	output += "<p>Вглядываясь в мелодичную насыщенность космоса, вы думаете о бесконечных мирах лишь ожидающих жатвы и о том, что все живое должно стать пищей для роста улья.<br/><br/>Из глубины темного космоса пугающего своей неизвестностью мира пришел неописуемый кошмар человечества - <b>ксеноморфы</b>. Чрезвычайно опасные инопланетные формы жизни, разделенные в разные ульи под управлением королев-матерей, застали миры ТГМС и НТ врасплох во время их открытия в 2414 году. Они разделены на касты, каждая из которых имеет свою специализацию схожую с родами войск. Это устройство ульев, идеальная координация их атак и самое главное, ненасытный голод привели к потере многих миров. Связь с колониями была потеряна, а космическая карта потемнела. На одной из потемневших планет после нескольких дней жатвы одним из ульев королева почувствовала прибытие чужеродного железного улья на орбите.<br/><br/>Закончив жатву в этом мире вы двинетесь в следующий, так же как было с многими мирами до этого. Потому, что единственное, что улей может делать – это расти и все живое принадлежит вам и должно быть переработано. У всех живых существ встреченных вами есть лишь право быть усвоенными… во благо улья и королевы.</p>"
	output += "</div>"
